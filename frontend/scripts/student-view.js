...
async function fetchStudentDetails() {
    ...
    try {
        ...
        const attRes = await fetch(`http://localhost:5000/api/attendance/student/${studentId}`);
...
saveStudentBtn.addEventListener("click", async () => {
    ...
    try {
        const response = await fetch(`http://localhost:5000/api/students/${currentStudent._id}`, {
            method: "PUT",
